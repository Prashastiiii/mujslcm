      ...
      <div class="container">
        ...
        <?php 
         ...
         if(mysqli_num_rows($verify_query) !=0 ){
            ...
            mysqli_query($con,"INSERT INTO users(Username,Email,Age,Password,Attendance,Course,GPA,Semester) VALUES('$username','$email','$age','$password','$Attendance','$Course','$GPA','$Semester')") or die("Erroe Occured");
